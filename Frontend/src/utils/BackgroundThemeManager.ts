...
class BackgroundThemeManager {
  ...
  private themes: { [key: string]: BackgroundThemeConfig } = {
    dark: {
      name: 'dark',
      displayNameKey: 'background_theme.dark',
      colors: {
    ...
    light: {
      name: 'light',
      displayNameKey: 'background_theme.light',
      colors: {
    ...
    midnight: {
      name: 'midnight',
      displayNameKey: 'background_theme.midnight',
      colors: {
    ...
    carbon: {
      name: 'carbon',
      displayNameKey: 'background_theme.carbon',
      colors: {
    ...
    ocean: {
      name: 'ocean',
      displayNameKey: 'background_theme.ocean',
      colors: {
    ...
    forest: {
      name: 'forest',
      displayNameKey: 'background_theme.forest',
      colors: {
    ...
    crimson: {
      name: 'crimson',
      displayNameKey: 'background_theme.crimson',
      colors: {
    ...
    cosmic: {
      name: 'cosmic',
      displayNameKey: 'background_theme.cosmic',
      colors: {
  ...
  getCurrentThemeConfigTranslated(): (BackgroundThemeConfig & { displayName: string }) | null {
