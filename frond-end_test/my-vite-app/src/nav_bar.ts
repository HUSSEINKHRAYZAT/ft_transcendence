...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://www.flaticon.com/free-icon/pong_1890552?term=pong&related_id=1890552" class="h-8" alt="Pong logo" />
      <span class="font-poppins text-2xl font-semibold whitespace-nowrap dark:text-white">FT_PONG </span>
  </a>
...
document.addEventListener('DOMContentLoaded', () => {
  const toggleButton = document.querySelector<HTMLButtonElement>('[data-collapse-toggle="navbar-language"]');
