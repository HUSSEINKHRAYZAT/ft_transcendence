...
import {
  BaseTexture,
  Texture
} from "./chunk-GDFIS4FA.js";
import {
  SerializationHelper
} from "./chunk-KMB567JF.js";
import {
  Color3
} from "./chunk-R4EQ6O77.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-5VBWPCIP.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-YK3TDFLU.js");
    const textures = [];
...
//# sourceMappingURL=chunk-6YL3S7NT.js.map
