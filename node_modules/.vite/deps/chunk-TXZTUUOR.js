...
import {
  ...
  Quaternion,
  Vector3
} from "./chunk-TMDW5ZYT.js";
import {
  AbstractEngine
} from "./chunk-Q25CKXTC.js";
import {
  EngineStore
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name, options = {}) {
    const module = await import("./webAudioBus-J75KJZTE.js");
  ...
  async createSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStaticSound-3OXQT3OU.js");
  ...
  async createSoundSourceAsync(name, source, options = {}) {
    const module = await import("./webAudioSoundSource-IXOGTXW7.js");
  ...
  async createStreamingSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStreamingSound-PZT3QZQF.js");
...
//# sourceMappingURL=chunk-TXZTUUOR.js.map
