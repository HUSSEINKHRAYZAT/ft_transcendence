...
import {
  BaseTexture,
  Texture
} from "./chunk-BJBZF5PD.js";
import {
  SerializationHelper
} from "./chunk-FGZX6FEK.js";
import {
  Color3
} from "./chunk-27IJGUOD.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
...
import {
  Clamp
} from "./chunk-N4QCFDDR.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-XENRAWMR.js";
import {
  FloorPOT,
  GetExponentOfTwo,
  IsExponentOfTwo,
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-MH34SWNV.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-AVSDKZWG.js");
    const textures = [];
...
//# sourceMappingURL=chunk-RAKIYIDG.js.map
