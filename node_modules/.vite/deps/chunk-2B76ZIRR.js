...
} from "./chunk-XO5RP75L.js";
import {
  AbstractAudioNode,
  _WebAudioParameterComponent
} from "./chunk-XV4O7PLV.js";
import {
  Matrix,
  Quaternion,
  Vector3
} from "./chunk-QUBSTO67.js";
import {
  AbstractEngine
} from "./chunk-67EKSRFN.js";
import {
  EngineStore
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name, options = {}) {
    const module = await import("./webAudioBus-SK74DHJB.js");
  ...
  async createMainBusAsync(name, options = {}) {
    const module = await import("./webAudioMainBus-XXEMVCJ6.js");
  ...
  async createSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStaticSound-3BJREMJ2.js");
  ...
  async createSoundSourceAsync(name, source, options = {}) {
    const module = await import("./webAudioSoundSource-XMUZPAGH.js");
  ...
  async createStreamingSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStreamingSound-FPHCQXVZ.js");
...
//# sourceMappingURL=chunk-2B76ZIRR.js.map
