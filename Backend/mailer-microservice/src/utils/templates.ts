    ...
    <table width="100%" style="max-width:560px;margin:auto;background-color:#1f2937;border-radius:12px;overflow:hidden;">
      <tr>
        <td style="background-color:#84cc16;padding:20px;text-align:center;">
          <h1 style="margin:0;font-size:24px;color:#111827;font-weight:700;">YourApp</h1>
        </td>
      </tr>
      <tr>
        <td style="padding:32px;">
          ...
          <div style="text-align:center;margin-top:28px;">
            <a href="https://yourapp.com/verify"
               style="background-color:#84cc16;color:#111827;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:600;display:inline-block;">
              Verify Now
            </a>
          </div>
        </td>
