...
export const UpdateRelationBodyWithUsername = CreateRelationBodyWithUsername;
export type UpdateRelationBodyWithUsernameTS = Static<typeof UpdateRelationBodyWithUsername>;

export const UpdateRelationBody = CreateRelationBody;
export type UpdateRelationBodyTS = Static<typeof UpdateRelationBody>;

export const deleteRelationBody = Type.Object({
  usernameOne: Type.String(),
  usernameTwo: Type.String(),
});
export type deleteRelationBodyTS = Static<typeof deleteRelationBody>;
