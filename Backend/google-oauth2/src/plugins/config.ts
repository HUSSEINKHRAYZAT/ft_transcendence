...
export const configPlugin = fp(async (app) => {
  ...
  const cfg: AppConfig = {
    ...
    GOOGLE_REDIRECT_URI: process.env.GOOGLE_REDIRECT_URI ?? 'https://localhost:8080/authWithGoogle/callback',
    ...
    ALLOWED_REDIRECTS: process.env.ALLOWED_REDIRECTS ?? 'https://localhost:5173',
  };
