...
var name21 = "pbrBlockReflectance0";
var shader21 = `float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
var name22 = "pbrClusteredLightingFunctions";
var shader22 = `#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
var shader23 = `vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
var shader26 = `float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
var name27 = "pbrBlockReflectance";
var shader27 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
var name28 = "pbrBlockDirectLighting";
var shader28 = `vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
var name29 = "pbrBlockFinalLitComponents";
var shader29 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
var name30 = "pbrBlockFinalUnlitComponents";
var shader30 = `vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
var name31 = "pbrBlockFinalColorComposition";
var shader31 = `vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
var name32 = "pbrBlockImageProcessing";
var shader32 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
var name33 = "pbrBlockPrePass";
var shader33 = `#if SCENE_MRT_COUNT>0
...
var shader35 = `#define PBR_FRAGMENT_SHADER
...
`;
if (!ShaderStore.ShadersStore[name35]) {
  ShaderStore.ShadersStore[name35] = shader35;
}
var pbrPixelShader = { name: name35, shader: shader35 };

export {
  pbrPixelShader
};
//# sourceMappingURL=chunk-CVAOTTOS.js.map
