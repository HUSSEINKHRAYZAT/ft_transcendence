import {
  Scene
} from "./chunk-EICQQVYR.js";
import {
  ApplyPostProcess,
  CubeMapToSphericalPolynomialTools
} from "./chunk-SLGZ7OLL.js";
import {
  PostProcess,
  SphericalPolynomial
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRgbdTextureAsync = async () => {
      ...
      if (isWebGpu) {
        ...
        await import("./rgbdDecode.fragment-5XA3PTWV.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-LMIP27OK.js");
    } else {
...
//# sourceMappingURL=chunk-VIOOQFQG.js.map
