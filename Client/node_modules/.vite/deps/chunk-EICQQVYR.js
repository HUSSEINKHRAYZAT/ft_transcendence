import {
  Node
} from "./chunk-5JEY3KOO.js";
import {
  PointerEventTypes,
  PointerInfo,
  PointerInfoPre
} from "./chunk-QSCPYREE.js";
import {
  UniformBuffer,
  UniqueIdGenerator
} from "./chunk-6H4KXIRU.js";
import {
...
} from "./chunk-T3PBV4Y3.js";
import {
  PerfCounter
} from "./chunk-LJSODA3L.js";
import {
  Texture
} from "./chunk-5E7G3UN2.js";
import {
  SerializationHelper,
  Tags
} from "./chunk-AAOEWJZB.js";
import {
  Color3,
  Color4,
  TmpColors
} from "./chunk-DKR53P3I.js";
import {
  __decorate,
  expandToProperty,
  serialize,
  ...
  serializeAsVector2,
  serializeAsVector3
} from "./chunk-EIKIXNFQ.js";
import {
  DrawWrapper,
  EffectWrapper,
  Viewport
} from "./chunk-NQORWVCZ.js";
import {
  VertexBuffer
} from "./chunk-6JFLQ55T.js";
import {
  Tools
} from "./chunk-OLEZMACW.js";
import {
  LoadFile,
  ReadFile,
  RequestFile
} from "./chunk-XXRCUJHA.js";
import {
  BuildArray,
  Epsilon,
  Matrix,
...
var ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./kernelBlur.fragment-XKTAWUX5.js"), import("./kernelBlur.vertex-T6M3AJK3.js")]));
    } else {
...
var ShadowGenerator = class _ShadowGenerator {
  ...
  _createTargetRenderTexture() {
    ...
    (_a = this._shadowMap) == null ? void 0 : _a.dispose();
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-IRMOKQKF.js"),
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-AIYLNHRE.js"),
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-7AW2LTZF.js"), import("./depth.fragment-W5OGO4OC.js")]);
    } else {
      await Promise.all([import("./depth.vertex-Y6HYLH2O.js"), import("./depth.fragment-FB4LWFMM.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
var FrameGraphShadowGeneratorTask = class extends FrameGraphTask {
  ...
  _setupShadowGenerator() {
    var _a;
    (_a = this._shadowGenerator) == null ? void 0 : _a.dispose();
  ...
  isReady() {
    var _a;
    return !!this._shadowGenerator && !!((_a = this._shadowGenerator.getShadowMap()) == null ? void 0 : _a.isReadyForRendering());
  }
  /**
...
var FrameGraphPostProcessTask = class extends FrameGraphTask {
  ...
  record(skipCreationOfDisabledPasses = false, additionalExecute, additionalBindings) {
    ...
    pass.setExecuteFunc((context) => {
      additionalExecute == null ? void 0 : additionalExecute(context);
      context.applyFullScreenEffect(this._postProcessDrawWrapper, () => {
        ...
        additionalBindings == null ? void 0 : additionalBindings(context);
...
var FrameGraphCascadedShadowGeneratorTask = class extends FrameGraphShadowGeneratorTask {
  ...
  set autoCalcDepthBounds(value) {
    ...
    if (!value) {
      (_a = this._shadowGenerator) == null ? void 0 : _a.setMinMaxDistance(0, 1);
    }
...
//# sourceMappingURL=chunk-EICQQVYR.js.map
