...
.PHONY: all dev backend frontend backend-build backend-up backend-down backend-logs frontend-dev frontend-build frontend-preview frontend-reinstall clean help install
